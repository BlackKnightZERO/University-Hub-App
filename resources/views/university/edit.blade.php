                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('universities.update', $university) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control" name="title" value="{{ old('title', $university->title) }}" required autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <select name="division_id" id="" class="form-control">
                                ...
                                <option value={{ $division->id }} @if($division->id == $university->division->id) selected @endif>{{ $division->division_name_bn }}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <select name="university_fund_type_id" id="university_fund_type_id" class="form-control">
                                ...
                                <option value={{ $universityFundType->id }} @if($universityFundType->id == $university->universityFundType->id) selected @endif>{{ $universityFundType->title }}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <select multiple name="university_program_type_id[]" id="" class="form-control">
                                ...
                                <option value={{ $universityProgramType->id }} @if(in_array($universityProgramType->id, $selectedProgramTypes)) selected @endif>{{ $universityProgramType->title }}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <select name="university_type_id" id="" class="form-control">
                                ...
                                <option value={{ $universityType->id }} @if($universityType->id == $university->universityType->id) selected @endif>{{ $universityType->title }}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <textarea id="description" name="description" rows="4" class="form-control">{{ old('description', $university->description) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="short_links" class="col-sm-4 col-form-label text-md-right">{{ __('Short Links') }}</label>
                            <div class="col-md-6">
                            <textarea id="short_links" name="short_links" rows="4" class="form-control">{{ old('short_links', $university->short_links) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="phone" class="col-sm-4 col-form-label text-md-right">{{ __('Phone') }}</label>
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control" name="phone" value="{{ old('phone', $university->phone) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="seat_count" class="col-sm-4 col-form-label text-md-right">{{ __('Seat Count') }}</label>
                            <div class="col-md-6">
                                <input id="seat_count" type="number" class="form-control" name="seat_count" value="{{ old('seat_count', $university->seat_count) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="contact" class="col-sm-4 col-form-label text-md-right">{{ __('Contact') }}</label>
                            <div class="col-md-6">
                                <input id="contact" type="text" class="form-control" name="contact" value="{{ old('contact', $university->contact) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="gmap_link" class="col-sm-4 col-form-label text-md-right">{{ __('Gmap Link') }}</label>
                            <div class="col-md-6">
                                <input id="gmap_link" type="text" class="form-control" name="gmap_link" value="{{ old('gmap_link', $university->gmap_link) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="web_link" class="col-sm-4 col-form-label text-md-right">{{ __('Web Link') }}</label>
                            <div class="col-md-6">
                                <input id="web_link" type="text" class="form-control" name="web_link" value="{{ old('web_link', $university->web_link) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="email" class="col-sm-4 col-form-label text-md-right">{{ __('E-Mail') }}</label>
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="email" value="{{ old('email', $university->email) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="email_register" class="col-sm-4 col-form-label text-md-right">{{ __('E-Mail Register') }}</label>
                            <div class="col-md-6">
                                <input id="email_register" type="text" class="form-control" name="email_register" value="{{ old('email_register', $university->email_register) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="img" class="col-sm-4 col-form-label text-md-right">{{ __('Image') }}</label>
                            <div class="col-md-6">
                                <img class="h-auto rounded-lg w-100 col-md-4" alt="" id="output" src="{{ asset('/storage').'/'.$storagePath }}">
