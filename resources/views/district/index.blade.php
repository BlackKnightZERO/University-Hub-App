                    ...
                    <div class="relative overflow-auto flex flex-col w-full h-full text-gray-700 bg-white shadow-md rounded-lg bg-clip-border">
                        <table class="w-full text-left table-auto min-w-max">
                            ...
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="p-4 border-b border-slate-200">
                                <a href="{{ route('districts.edit', $district) }}" class="text-sm font-semibold text-blue-600">
                                    Edit
                                </a>&nbsp;|&nbsp;
                                <form action="{{ route('districts.destroy', $district) }}" method="POST" onsubmit="return confirm('Are you sure?')" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
