                ...
                <div class="overflow-hidden overflow-x-auto border-b border-gray-200 bg-white p-6">
                    <form action="{{ route('districts.update', $district) }}" method="POST">
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" value="{{ old('title', $district->title) }}" type="text" class="block mt-1 w-full" />
                            ...
                            <select name="divison_id" id="" class="border-gray-310 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                                ...
                                <option value={{ $divison->id }} @selected($divison->id == $district->divison->id)>{{ $divison->title }}</option>
                                @endforeach
                            </select>
